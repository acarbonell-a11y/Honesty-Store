...
import BillCard, { BillStatus } from '../UserComponent/BillCard';
...
const Bill = () => {
  ...
  // Bills data
  const bills: { id: string; billNumber: string; amount: string; date: string; status: BillStatus }[] = [
    { id: '1', billNumber: 'BILL-1001', amount: '120', date: '2025-08-27', status: 'Pending' },
    { id: '2', billNumber: 'BILL-1002', amount: '85', date: '2025-08-26', status: 'Paid' },
    { id: '3', billNumber: 'BILL-1003', amount: '200', date: '2025-08-25', status: 'Pending' },
  ];
