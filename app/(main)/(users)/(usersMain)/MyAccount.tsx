...
import { getUserProfileFireBase, getUserTransactions } from "functions/firebaseFunctions";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        >
          <Animated.Image source={{ uri: profileImage }} style={[styles.avatar, { transform: [{ scale: scaleProfile }] }]} />
        </Pressable>
